...
export const PLANTS = [
  { name: 'Arugula', code: 'ARU', icon: '🥬', color: '#84cc16', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 5, sqftSpacing: 4, lightLevel: 'medium' },
  ...
  { name: 'Beet', code: 'BET', icon: '🟣', color: '#be123c', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 9, sqftSpacing: 9, lightLevel: 'medium' },
  { name: 'Broccoli', code: 'BRC', icon: '🥦', color: '#166534', plantAfterFrostDays: -21, startIndoorsWeeks: 6, harvestWeeks: 9, sqftSpacing: 1, lightLevel: 'high' },
  { name: 'Cabbage', code: 'CAB', icon: '🥬', color: '#94a3b8', plantAfterFrostDays: -28, startIndoorsWeeks: 6, harvestWeeks: 11, sqftSpacing: 1, lightLevel: 'medium' },
  { name: 'Carrot', code: 'CAR', icon: '🥕', color: '#fb923c', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 9, sqftSpacing: 16, lightLevel: 'medium' },
  { name: 'Cauliflower', code: 'CAF', icon: '🥦', color: '#6b7280', plantAfterFrostDays: -21, startIndoorsWeeks: 6, harvestWeeks: 9, sqftSpacing: 1, lightLevel: 'high' },
  { name: 'Corn', code: 'CRN', icon: '🌽', color: '#f59e0b', plantAfterFrostDays: 7, startIndoorsWeeks: 0, harvestWeeks: 11, sqftSpacing: 1, lightLevel: 'high' },
  ...
  { name: 'Kale', code: 'KAL', icon: '🥬', color: '#1e3a8a', plantAfterFrostDays: -28, startIndoorsWeeks: 5, harvestWeeks: 8, sqftSpacing: 1, lightLevel: 'medium' },
  { name: 'Lettuce', code: 'LET', icon: '🥬', color: '#65a30d', plantAfterFrostDays: -28, startIndoorsWeeks: 4, harvestWeeks: 7, sqftSpacing: 4, lightLevel: 'low' },
  ...
  { name: 'Pea', code: 'PEA', icon: '🫛', color: '#22c55e', plantAfterFrostDays: -35, startIndoorsWeeks: 0, harvestWeeks: 10, sqftSpacing: 8, lightLevel: 'medium' },
  ...
  { name: 'Radish', code: 'RAD', icon: '🔴', color: '#ef4444', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 4, sqftSpacing: 16, lightLevel: 'medium' },
  { name: 'Spinach', code: 'SPI', icon: '🥬', color: '#0f766e', plantAfterFrostDays: -28, startIndoorsWeeks: 4, harvestWeeks: 6, sqftSpacing: 9, lightLevel: 'low' },
  ...
  { name: 'Swiss Chard', code: 'CHD', icon: '🥬', color: '#14b8a6', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 8, sqftSpacing: 4, lightLevel: 'low' },
