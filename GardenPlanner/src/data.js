...
export const PLANTS = [
  ...
  { name: 'Cilantro', code: 'CIL', icon: '🌿', color: '#10b981', plantAfterFrostDays: -14, startIndoorsWeeks: 0, harvestWeeks: 6, sqftSpacing: 9, lightLevel: 'medium' },
  ...
  { name: 'Parsley', code: 'PAR', icon: '🌿', color: '#16a34a', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 10, sqftSpacing: 4, lightLevel: 'medium' },
