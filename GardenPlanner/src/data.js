...
export const PLANTS = [
  ...
  { name: 'Lettuce', code: 'LET', icon: '🥬', color: '#65a30d', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 7, sqftSpacing: 4, lightLevel: 'low' },
  ...
  { name: 'Spinach', code: 'SPI', icon: '🥬', color: '#0f766e', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 6, sqftSpacing: 9, lightLevel: 'low' },
