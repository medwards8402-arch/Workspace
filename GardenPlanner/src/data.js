...
export const PLANTS = [
  { name: 'Arugula', code: 'ARU', icon: '🥬', color: '#84cc16', type: 'vegetable', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 5, sqftSpacing: 4, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 28, fallStartIndoorsWeeks: 0 },
  ...
  { name: 'Beet', code: 'BET', icon: '🟣', color: '#be123c', type: 'vegetable', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 9, sqftSpacing: 9, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 56, fallStartIndoorsWeeks: 0 },
  ...
  { name: 'Cabbage', code: 'CAB', icon: '🥬', color: '#94a3b8', type: 'vegetable', plantAfterFrostDays: -28, startIndoorsWeeks: 6, harvestWeeks: 11, sqftSpacing: 1, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 70, fallStartIndoorsWeeks: 6 },
  { name: 'Carrot', code: 'CAR', icon: '🥕', color: '#fb923c', type: 'vegetable', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 9, sqftSpacing: 16, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 70, fallStartIndoorsWeeks: 0 },
  ...
  { name: 'Chives', code: 'CHV', icon: '🌿', color: '#4ade80', type: 'herb', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 52, sqftSpacing: 16, lightLevel: 'medium' },
  { name: 'Cilantro', code: 'CIL', icon: '🌿', color: '#10b981', type: 'herb', plantAfterFrostDays: -14, startIndoorsWeeks: 0, harvestWeeks: 6, sqftSpacing: 9, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 28, fallStartIndoorsWeeks: 0 },
  { name: 'Corn', code: 'CRN', icon: '🌽', color: '#f59e0b', type: 'vegetable', plantAfterFrostDays: 7, startIndoorsWeeks: 0, harvestWeeks: 11, sqftSpacing: 4, lightLevel: 'high', tips: ['Plant in blocks (not single rows) for better pollination', 'Heavy feeder; amend soil and keep evenly watered'] },
  ...
  { name: 'Kale', code: 'KAL', icon: '🥬', color: '#1e3a8a', type: 'vegetable', plantAfterFrostDays: -28, startIndoorsWeeks: 5, harvestWeeks: 8, sqftSpacing: 1, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 70, fallStartIndoorsWeeks: 5 },
  ...
  { name: 'Mint', code: 'MNT', icon: '🌿', color: '#34d399', type: 'herb', plantAfterFrostDays: -7, startIndoorsWeeks: 0, harvestWeeks: 52, sqftSpacing: 1, lightLevel: 'medium', tips: ['Spreads aggressively; consider a container or root barrier'] },
  ...
  { name: 'Parsley', code: 'PAR', icon: '🌿', color: '#16a34a', type: 'herb', plantAfterFrostDays: -21, startIndoorsWeeks: 0, harvestWeeks: 10, sqftSpacing: 4, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 60, fallStartIndoorsWeeks: 0 },
  { name: 'Pea', code: 'PEA', icon: '🫛', color: '#22c55e', type: 'vegetable', plantAfterFrostDays: -35, startIndoorsWeeks: 0, harvestWeeks: 10, sqftSpacing: 8, lightLevel: 'medium', supportsFall: false },
  ...
  { name: 'Radish', code: 'RAD', icon: '🔴', color: '#ef4444', type: 'vegetable', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 4, sqftSpacing: 16, lightLevel: 'medium', supportsFall: true, fallPlantBeforeFrostDays: 28, fallStartIndoorsWeeks: 0 },
