...
export const PLANTS = [
  ...
  { name: 'Asparagus', code: 'ASP', icon: '🌿', color: '#059669', plantAfterFrostDays: -14, startIndoorsWeeks: 0, harvestWeeks: 104, sqftSpacing: 1, lightLevel: 'high', tips: ['Perennial; do not harvest for 2–3 years after planting crowns', 'Dedicated bed recommended; deep roots and long-lived'] },
  ...
  { name: 'Corn', code: 'CRN', icon: '🌽', color: '#f59e0b', plantAfterFrostDays: 7, startIndoorsWeeks: 0, harvestWeeks: 11, sqftSpacing: 4, lightLevel: 'high', tips: ['Plant in blocks (not single rows) for better pollination', 'Heavy feeder; amend soil and keep evenly watered'] },
  ...
  { name: 'Garlic', code: 'GAR', icon: '🧄', color: '#78350f', plantAfterFrostDays: -180, startIndoorsWeeks: 0, harvestWeeks: 30, sqftSpacing: 4, lightLevel: 'high', tips: ['Best planted in fall for summer harvest', 'Mulch well over winter in cold climates'] },
  ...
  { name: 'Lettuce', code: 'LET', icon: '🥬', color: '#65a30d', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 7, sqftSpacing: 4, lightLevel: 'low', supportsFall: true, fallPlantBeforeFrostDays: 45, fallStartIndoorsWeeks: 0, tips: ['Bolts in heat; provide shade or succession plant in warm weather'] },
  ...
  { name: 'Mint', code: 'MNT', icon: '🌿', color: '#34d399', plantAfterFrostDays: -7, startIndoorsWeeks: 0, harvestWeeks: 52, sqftSpacing: 1, lightLevel: 'medium', tips: ['Spreads aggressively; consider a container or root barrier'] },
  ...
  { name: 'Potato', code: 'POT', icon: '🥔', color: '#a16207', plantAfterFrostDays: -7, startIndoorsWeeks: 0, harvestWeeks: 12, sqftSpacing: 1, lightLevel: 'high', tips: ['Hill soil or mulch around stems to improve yield and prevent greening'] },
  { name: 'Pumpkin', code: 'PUM', icon: '🎃', color: '#ea580c', plantAfterFrostDays: 14, startIndoorsWeeks: 0, harvestWeeks: 14, sqftSpacing: 1, lightLevel: 'high', cellsRequired: 4, tips: ['Very sprawling; give ample space or trellis small varieties'] },
  ...
  { name: 'Spinach', code: 'SPI', icon: '🥬', color: '#0f766e', plantAfterFrostDays: -28, startIndoorsWeeks: 0, harvestWeeks: 6, sqftSpacing: 9, lightLevel: 'low', supportsFall: true, fallPlantBeforeFrostDays: 45, fallStartIndoorsWeeks: 0, tips: ['Prefers cool weather; bolts quickly in heat'] },
  ...
  { name: 'Strawberries', code: 'STR', icon: '🍓', color: '#f43f5e', plantAfterFrostDays: -14, startIndoorsWeeks: 0, harvestWeeks: 52, sqftSpacing: 4, lightLevel: 'high', tips: ['Perennial; renovate beds annually and manage runners'] },
  ...
  { name: 'Tomato', code: 'TOM', icon: '🍅', color: '#dc2626', plantAfterFrostDays: 14, startIndoorsWeeks: 6, harvestWeeks: 10, sqftSpacing: 1, lightLevel: 'high', tips: ['Provide support (stakes/cages); prune indeterminates for airflow'] },
